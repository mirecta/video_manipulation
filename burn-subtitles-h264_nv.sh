...
ffmpeg  -stats   -i "$MOVIE"   -c:a libmp3lame -b:v 600k -q:a 1 -c:v h264_nvenc -preset slow -tune film -profile:v main -level 4.0    -vf "ass='${MOVIE_FILENAME}.ass'"  "$TARGET_MOVIE" 
